          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para ligações.
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Deixe seu feedback, sugestão e idéias.
                </Text>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:rdamasceno1852@gmail.com")
                  }
                >
                  Enviar e-mail
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Para criamos conexões por meio do network
                </Text>
                <Text
                  as="a"
                  color="grey2"
